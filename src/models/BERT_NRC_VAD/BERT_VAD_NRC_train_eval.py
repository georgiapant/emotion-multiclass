...
from src.models import BERT_NRC_VAD
from src.models.BERT_NRC_VAD import BERT_NRC_VAD
...
class BertVadNrc:
    ...
    def initialize_model(self, train_dataloader, epochs, num_labels, BERT_MODEL):
        ...
        classifier = BERT_NRC_VAD.BertVadNrcClassifier(num_labels, BERT_MODEL, freeze_bert=False)
    ...
    def main(self, model_name):
        ...
        train(bert_classifier, train_dataloader, self.EPOCHS, self.es, self.patience, self.project_root_path,
              self.device, self.loss_fn, val_dataloader, optimizer, scheduler, evaluation=True, vad_nrc=True,
