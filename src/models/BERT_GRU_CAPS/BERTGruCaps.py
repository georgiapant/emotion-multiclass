...
from capsule_layer import CapsuleLinear # https://github.com/leftthomas/CapsuleLayer
...
class bertGruClassifier(nn.Module):
    ...
    def __init__(self, num_labels, BERT_MODEL, BATCH_SIZE, freeze_bert=False): #, BERT_MODEL, num_labels, BATCH_SIZE):
        """
